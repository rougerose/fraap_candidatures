...
function stage_action_insert_candidature($id_auteur) {
	...
	$id_candidature = sql_insertq('spip_candidatures', [
...
function action_candidature_set($id_candidature, $set = null) {
	...
	autoriser_exception('modifier', 'candidature', $id_candidature);
	$retour = objet_modifier('candidature', $id_candidature, $c);
	autoriser_exception('modifier', 'candidature', $id_candidature, false);
